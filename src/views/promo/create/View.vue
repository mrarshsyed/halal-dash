  ...
  <div>
    ...
    <form @submit="handleSubmit" class="mt-4" validate-on="submit lazy">
      ...
      <div class="mt-4">
        ...
        <input id="startDate" name="start_date" v-model="form.start_date" type="date"
          class="form-input border" />
      </div>
      ...
      <div class="mt-4">
        ...
        <input id="endDate" name="end_date" v-model="form.end_date" type="date" class="form-input border" />
      </div>
